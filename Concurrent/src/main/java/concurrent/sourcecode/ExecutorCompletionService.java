...
public class ExecutorCompletionService<V> implements java.util.concurrent.CompletionService<V> {
    ...
    public ExecutorCompletionService(java.util.concurrent.Executor executor) {
        ...
        this.completionQueue = new LinkedBlockingQueue<java.util.concurrent.Future<V>>();
    }
    ...
    public ExecutorCompletionService(Executor executor,
                                     BlockingQueue<java.util.concurrent.Future<V>> completionQueue) {
    ...
    public java.util.concurrent.Future<V> submit(Callable<V> task) {
    ...
    public java.util.concurrent.Future<V> submit(Runnable task, V result) {
        if (task == null) throw new NullPointerException();
    ...
    public java.util.concurrent.Future<V> take() throws InterruptedException {
