...
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V>
    ...
    static final class Segment<K, V> extends ReentrantLock implements Serializable {
         ...
         * 这个 hash 不是用来对应 Segment 么, 每个 Segment 中的
         */
...
//            根据 hash 和 掩码获取 idx
        ...
        void rehash() {
             ...
             * right now.
             *
             * 这个函数应该能够解释 为什么使用 2 的指数作为 map 的 length
             * 为什么是 1/6
             * 怎么知道有其他 thread 在遍历此数组?
             * Segment 的个数不变, 因为他影响的是并发粒度
             */
            ...
            for (int i = 0; i < oldCapacity; i++) {
                ...
                if (e != null) {
                    ...
                    if (next == null)
                        ...
                        //拿到新 idx 的第一个元素, 作为new idx 的头, 它是老 idx 最下面的那个元素
