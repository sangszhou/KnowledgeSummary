...
package concurrent.sourcecode.atomic;
...
public class AtomicMarkableReference<V>  {
    ...
    private final java.util.concurrent.atomic.AtomicReference<ReferenceBooleanPair<V>> atomicRef;
    ...
    public AtomicMarkableReference(V initialRef, boolean initialMark) {
        atomicRef = new java.util.concurrent.atomic.AtomicReference<ReferenceBooleanPair<V>>(new ReferenceBooleanPair<V>(initialRef, initialMark));
    }
