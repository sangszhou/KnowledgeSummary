...
public class AtomicStampedReference<V>  {
    ...
    private final java.util.concurrent.atomic.AtomicReference<ReferenceIntegerPair<V>> atomicRef;
    ...
    public AtomicStampedReference(V initialRef, int initialStamp) {
        atomicRef = new java.util.concurrent.atomic.AtomicReference<ReferenceIntegerPair<V>>
