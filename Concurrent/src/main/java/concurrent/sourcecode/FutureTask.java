 ...
 * or cancelled.
 *
 * <p>A <tt>FutureTask</tt> can be used to wrap a {@link java.util.concurrent.Callable} or
...
public class FutureTask<V> implements RunnableFuture<V> {
    ...
    private final class Sync extends AbstractQueuedSynchronizer {
        ...
        V innerGet() throws InterruptedException, java.util.concurrent.ExecutionException {
        ...
        V innerGet(long nanosTimeout) throws InterruptedException, java.util.concurrent.ExecutionException, TimeoutException {
